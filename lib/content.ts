export const profile = {
  ...
  about: [
    "Software engineer at Equal (identity verification, Hyderabad), IIT Hyderabad '24. Two years shipping AI systems that do real work in production: retrieval and LLM adjudication over 200M+ court records, autonomous document-collection agents, voice agents, and internal LLM chatbots — serving 50+ enterprise clients.",
